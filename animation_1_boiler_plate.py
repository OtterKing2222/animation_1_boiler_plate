...
# canvas variables
width = 1000 # adjust for width of canvas
...
# import assets
sprite_sheet = pygame.image.load("Fire 2.png").convert_alpha() # add the path/name of your sprite sheet file

# get details about individual sprites
total_sprites = 4 # code the number of sprite images your sprite sheet has
